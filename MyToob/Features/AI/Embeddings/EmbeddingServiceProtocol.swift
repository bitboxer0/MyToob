...
public protocol EmbeddingServiceProtocol: Sendable {
    /// Whether the embedding model is available on this device/OS version
    ///
    /// Use this to gracefully degrade features when embeddings are unavailable.
    var isModelAvailable: Bool { get async }
